const elementList = {
	...
	title : 
	{
		name : 'Мировые новости в одном месте',
		desc : 'Последние мировые новости и события часа. Смотрите видеорепортажи о главных мировых событиях онлайн. Только актуальные ...'
	},
	params : 
	{
		animDelay : 3000,
